...
public class ClassSessionServiceImpl implements ClassSessionService {
    ...
    public boolean updateClassSession(ClassSessionRequestDTO classSessionRequestDTO) {
        ...
        if (classSessionRequestDTO.getId() == null) {
            return false;
        }
        ...
        if (classSession != null) {
            ...
            if (classSessionRequestDTO.getDate() != null) {
                classSession.setDate(classSessionRequestDTO.getDate());
            }
            if (classSessionRequestDTO.getLocationId() != null) {
                Location location = locationRepository.findById(classSessionRequestDTO.getLocationId()).orElse(null);
                if (location != null) {
                    classSession.setLocation(location);
                }
            ...
            if (classSessionRequestDTO.getTimeSlotId() != null&&classSession.getTimeSlot().getId()!=classSessionRequestDTO.getTimeSlotId()) {
                TimeSlot timeSlot = timeSlotRepository.findById(classSessionRequestDTO.getTimeSlotId()).orElse(null);
                if (timeSlot != null) {
                    classSession.getTimeSlot().removeClassSession(classSession);
                    timeSlot.addClassSession(classSession);
                }
            }
